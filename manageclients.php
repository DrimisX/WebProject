...
<h2>Not meant for normal users.</h2>
...
<?php
	...
	if($displayOriginal) {
		...
		echo "<form name=\"clients\" action=\"manageclients.php\" method=\"post\">";
		echo "I want to ";
		...
		echo " the client ID of <select name=\"clientid\">\n";
		echo "<option value=\"all\" selected>all</option>\n";
		while($row = mysqli_fetch_array($result)) {
			echo "<option value=\"".$row['client_id']."\">".$row['client_id']." (".$row['client_username'].")</option>\n";
		}
		echo "</select>\n";
		echo ".\n";
